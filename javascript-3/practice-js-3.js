//////////////////STEP 1////////////////////
/* Create an array called 'groceries' that contains three 
grocery items of your choice as strings. */

//CODE HERE

let groceries = ["strawberries", "chocolate", "yogurt"]
...
/*
    ...
    Inside of the removeItem function, remove the item that corresponds to the 
    index parameter
...
/*
    ...
    you're going to check the total number of groceries in your groceries array 
    using .length. 
    ...
    If the amount of groceries is between 1 and 5, return the 
    string 'NUMBEROFGROCERIES items' 
